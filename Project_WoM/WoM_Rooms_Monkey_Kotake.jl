...
This file is dedicated to Day 2 WITH the monkey and WITH Kotake

The only difference between this file and WoM_Rooms_Monkey_No_Kotake.jl is that
Kotake is NOT cleared in this file
...
Room8_Scene_Load_Actor_List = [
    ...
    unloadable=false,
    clearable=true,
    cleared=false,   ########################### Kotake is NOT cleared
...
Room8_Actor_List_Prev = [
    ...
    Room8_Scene_Load_Actor_List[3], # Kotake (NOT cleared)
